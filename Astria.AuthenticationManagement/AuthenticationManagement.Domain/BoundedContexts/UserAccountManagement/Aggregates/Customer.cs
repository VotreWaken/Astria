...
namespace AuthenticationManagement.Domain.BoundedContexts.UserAccountManagement.Aggregates
{
	public class Customer : AggregateRoot
	{
		...
		public Customer(Guid userId, string email, string hashedPassword, string firstname, string lastname, Guid userImageId)
		{
			...
			Console.WriteLine("UserImageId at CustomerEvent: " + userImageId);
